...
%% Nakagami Path Loss Model -this takes transmitted power(Pt_dBm) as input.

function [rxSignal,Ch_Coef,NoiseVariance] = channel_NK_PL(txSignal,Pt_dBm,dist,rateid,prm80211p)

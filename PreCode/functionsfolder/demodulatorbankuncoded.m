function rxdata = demodulatorbankuncoded(demodin,rateid,numBits,prm80211p)
...
switch rateid
    ...
    case 5
        ...
        % Size of signal constellation
        M=16;
        demoddataout = qamdemod(demodin, M,'gray','OutputType','bit','UnitAveragePower',true);
    case 6

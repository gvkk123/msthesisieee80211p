function [weight,loss_ratio] = PLRAnalysis2(user_density,EbNo,rateid,PacketSize)
...
ChannelMode = 3;
[Y_H_Cell,H_Ch,H_est_perfectCSI] =channelframefn(prmTIMING,user_density,UserCell,ChannelMode,EbNo,rateid,prm80211p);

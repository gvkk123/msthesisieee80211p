...
for n = 1:length(EbNoVec)
    ...
    while numErrs < 100 && numBitsTotal < 1e6
        ...
        %Channel
        %EbNoVec=15;
        [rxSignal,Ch_Coef,NoiseVariance] = channel_TDL(txSignal,EbNoVec(n),rateid,prm80211p);
...
%plot(ebno0,ber0)
legend('Decoded -V2V Channel-perfect CSI ','Theoritical Uncoded QPSK','Theoritical Coded QPSK UB','location','best');
grid;
xlabel('Eb/No (dB)');
